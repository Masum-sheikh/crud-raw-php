...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="/creative/admin_asset/images/favicon.png">
	<link rel="stylesheet" href="./vendor/chartist/css/chartist.min.css">
    <link href="/creative/admin_asset/vendor/bootstrap-select/dist/css/bootstrap-select.min.css" rel="stylesheet">
	<link href="/creative/admin_asset/vendor/owl-carousel/owl.carousel.css" rel="stylesheet">
    <link href="/creative/admin_asset/css/style.css" rel="stylesheet">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                <img class="logo-abbr" src="/creative/admin_asset/images/logo.png" alt="">
                <img class="logo-compact" src="/creative/admin_asset/images/logo-text.png" alt="">
                <img class="brand-title" src="/creative/admin_asset/images/logo-text.png" alt="">
            </a>
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                    <img src="/creative/admin_asset/images/profile/17.jpg" width="20" alt=""/>
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="/creative/users/profile.php" class="dropdown-item ai-icon">
                                    ...
                                    <a href="/creative/logout.php" class="dropdown-item ai-icon">
        ...
        <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    <li><a class="has-arrow ai-icon" href="/creative/admin.php" >
							<i class="flaticon-381-networking"></i>
							<span class="nav-text">Dashboard</span>
						</a>
                        
                    </li>
                    <li><a class="has-arrow ai-icon" href="/creative/users/user_list.php">
							<i class="flaticon-381-television"></i>
							<span class="nav-text">usee list</span>
						</a>
